...
export default function Header({ darkTheme }: Props) {
    return (
        <div className={`flex flex-wrap justify-center w-full md:w-auto md:mx-8 pt-5 md:flex-row ${darkTheme ? 'text-neutral-900' : 'text-neutral-300'} bg-neutral-100 pb-8 rounded-b-2xl`}>
